class GamestopScraper::CLI
    ...
    def menu
        ...
        puts " "
        puts "   Please type ".colorize(:yellow) + "'new games'".colorize(:light_blue) + " to see a list the top 6 new games,".colorize(:yellow)
        puts "  or ".colorize(:yellow) + "'upcoming games'".colorize(:light_blue) + " to  see the top 6 games releasing soon!".colorize(:yellow)
    ...
    def commands_detail
        puts " "
        puts "  Type a number ".colorize(:yellow) + "(1-6)".colorize(:light_blue) + " to see an upcoming release!".colorize(:yellow)
    ...
    def detail_results(array)
        ...
        # puts ("Publisher: ".colorize(:light_blue) + @game.publisher.colorize(:light_cyan)) unless @game.release_date == nil
        # puts ("Release Date: ".colorize(:light_blue) + @game.release_date.colorize(:light_cyan)) unless @game.release_date == nil
        ...
        puts " "
        puts "You can request a short description of the game with ".colorize(:yellow) + "'description'".colorize(:light_blue) + "!".colorize(:yellow)
        puts " "
